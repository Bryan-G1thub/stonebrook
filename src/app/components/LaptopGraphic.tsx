    ...
    <div className="w-full h-full flex items-center justify-center p-8">
      ...
      <div className="relative max-w-full">
        ...
        <div className="relative">
          {/* Screen Bezel */}
          <div className="bg-gray-900 rounded-t-2xl p-3 shadow-2xl border-8 border-gray-900">
            {/* Screen Content */}
            <div className="w-[500px] h-[320px] bg-[#0A1628] rounded-t-lg overflow-hidden relative">
              {/* Terminal Header */}
              <div className="h-8 bg-gray-800/50 flex items-center px-4 gap-2 border-b border-gray-700/50">
              ...
              <div className="p-6 font-mono text-xs">
                {codeLines.map((line, index) => (
                  ...
                  >
                    <span className="text-gray-600 w-6 text-right mr-4 select-none text-[10px]">
                      {index + 1}
                    </span>
                    <span
          ...
          <div className="relative">
            {/* Keyboard section */}
            <div className="h-8 bg-gray-800 rounded-b-2xl shadow-xl" />

            {/* Base shadow */}
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-[550px] h-3 bg-gray-900/50 rounded-full blur-xl" />
          </div>
        </div>
        ...
        <motion.div
          ...
          className="absolute top-4 right-4 flex items-center gap-2 bg-green-500/20 backdrop-blur-sm px-3 py-1.5 rounded-full border border-green-400/30"
        >
